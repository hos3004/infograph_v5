...
`;
        ...
        children: [
          ...
          /\.(mp4|mov|webm|mkv)$/i.test(slide.imageUrl) ? /* @__PURE__ */ (0, import_jsx_runtime22.jsx)(
            Video,
            {
              ...
              startFrom: Math.max(0, Math.round((slide.trimStartMs || 0) / 1e3 * 30)),
              endAt: slide.trimEndMs ? Math.max(1, Math.round(slide.trimEndMs / 1e3 * 30)) : void 0,
              style: {
                width: 1920,
                height: 1080,
                objectFit: "cover",
  ...
  // src/remotion/personalities/timeline.ts
  var DEFAULT_IMAGE_DURATION_MS = 8e3;
  ...
  var PersonalitiesComposition = ({
    ...
    return /* @__PURE__ */ (0, import_jsx_runtime25.jsxs)(AbsoluteFill, { style: { backgroundColor: "#000", direction: "ltr" }, children: [
      slides.map((slide, i) => {
        ...
        return /* @__PURE__ */ (0, import_jsx_runtime25.jsx)(
          Sequence,
          {
            ...
            layout: "none",
            children: /* @__PURE__ */ (0, import_jsx_runtime25.jsx)(AbsoluteFill, { style: { overflow: "hidden" }, children: isVideo ? /* @__PURE__ */ (0, import_jsx_runtime25.jsx)(
              Video,
              {
                src: slide.mediaUrl,
                muted: slide.isMuted !== false,
                startFrom: Math.max(0, Math.round((slide.trimStartMs || 0) / 1e3 * FPS)),
                endAt: slide.trimEndMs != null && slide.trimEndMs > 0 ? Math.max(1, Math.round(slide.trimEndMs / 1e3 * FPS)) : void 0,
      ...
      extendMs > 0 && lastSlide && /* @__PURE__ */ (0, import_jsx_runtime25.jsx)(
        Sequence,
        {
          from: msToFrames(slidesTotalMs, FPS),
          durationInFrames: msToFrames(extendMs, FPS),
          layout: "none",
          children: /* @__PURE__ */ (0, import_jsx_runtime25.jsx)(AbsoluteFill, { style: { overflow: "hidden" }, children: lastSlide.mediaType === "video" ? /* @__PURE__ */ (0, import_jsx_runtime25.jsx)(
            Video,
            {
              src: lastSlide.mediaUrl,
              muted: lastSlide.isMuted !== false,
              startFrom: Math.max(0, Math.round(((lastSlide.trimEndMs || lastSlide.mediaDurationMs || lastSlide.durationMs) - 1e3) / 1e3 * FPS)),
              endAt: Math.max(1, Math.round((lastSlide.trimEndMs || lastSlide.mediaDurationMs || lastSlide.durationMs) / 1e3 * FPS)),
              style: { width: 1920, height: 1080, objectFit: "cover" }
            }
          ) : /* @__PURE__ */ (0, import_jsx_runtime25.jsx)(
            Img,
      ...
      endPagePresent && /* @__PURE__ */ (0, import_jsx_runtime25.jsx)(
        Sequence,
        {
          from: Math.max(0, durationInFrames - endPageDurationFrames),
          durationInFrames: endPageDurationFrames,
          layout: "none",
          children: /* @__PURE__ */ (0, import_jsx_runtime25.jsx)(AbsoluteFill, { style: { backgroundColor: "#000" }, children: /* @__PURE__ */ (0, import_jsx_runtime25.jsx)(
            Video,
            {
              src: endPage,
              style: { width: "100%", height: "100%", objectFit: "cover" }
      ...
      music && /* @__PURE__ */ (0, import_jsx_runtime25.jsx)(
        Audio,
        {
          src: music,
          loop: true,
  ...
  function isPersonalitiesMode(props) {
  ...
  function renderPreview() {
    ...
    previewRoot.render(/* @__PURE__ */ (0, import_jsx_runtime26.jsx)(PreviewApp, { payload: currentPayload }));
  }
