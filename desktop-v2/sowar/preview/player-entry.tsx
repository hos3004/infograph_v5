...
import { SowarComposition } from '../../../src/remotion/sowar/SowarComposition';
import type { SowarProps } from '../../../src/remotion/sowar/types';

type PreviewPayload = {
  inputProps: SowarProps;
...
declare global {
  interface Window {
    DesktopRemotionPreviewSowar?: PreviewApi;
  }
}
