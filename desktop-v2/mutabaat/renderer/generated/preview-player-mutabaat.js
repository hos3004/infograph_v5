"use strict";
var DesktopRemotionPreviewMutabaatBundle = (() => {
  ...
  // desktop-v2/mutabaat/preview/player-entry.tsx
...
`;
  ...
  // src/remotion/mutabaat/MutabaatComposition.tsx
  var import_jsx_runtime3 = __toESM(require_jsx_runtime());
  var FPS = 25;
  var DEFAULT_SLIDE_MS = 15e3;
  var FINAL_SLIDE_MS = 2e4;
  ...
  var DEFAULT_OVERLAY = staticFile("assets/mutabaat/slide.webm");
  var DEFAULT_FINAL_OVERLAY = staticFile("assets/mutabaat/final-slide.webm");
  var DEFAULT_MUSIC = staticFile("assets/mutabaat/news-clock-intense-loop.wav");
  var isRTL = (text) => /[\u0591-\u07FF\uFB1D-\uFDFD\uFE70-\uFEFC]/.test(text);
  var VideoLayer = (props) => {
    if (!props.src)
      return null;
    if (IS_PLAYER)
      return /* @__PURE__ */ (0, import_jsx_runtime3.jsx)(Video, { ...props });
    return /* @__PURE__ */ (0, import_jsx_runtime3.jsx)(OffthreadVideo, { ...props });
  };
  function getMutabaatSlideDurationMs(index, total, value) {
    if (Number.isFinite(value) && Number(value) > 0)
      return Number(value);
    return index === total - 1 ? FINAL_SLIDE_MS : DEFAULT_SLIDE_MS;
  }
  var SlideText = ({ text, bottomOffset, fontSize }) => {
    const frame = useCurrentFrame();
  ...
  var MutabaatSlideScene = ({ slide, overlayUrl, textBottomOffset, textFontSize }) => {
    const frame = useCurrentFrame();
    const zoom = interpolate(frame, [0, 375], [1.02, 1.11], {
      extrapolateLeft: "clamp",
      extrapolateRight: "clamp"
    });
    return /* @__PURE__ */ (0, import_jsx_runtime3.jsxs)(AbsoluteFill, { style: { backgroundColor: "#05070d" }, children: [
      slide.imageUrl ? /* @__PURE__ */ (0, import_jsx_runtime3.jsxs)(import_jsx_runtime3.Fragment, { children: [
        /* @__PURE__ */ (0, import_jsx_runtime3.jsx)(
          Img,
          {
            src: slide.imageUrl,
      ...
      /* @__PURE__ */ (0, import_jsx_runtime3.jsx)(AbsoluteFill, { style: { pointerEvents: "none" }, children: /* @__PURE__ */ (0, import_jsx_runtime3.jsx)(
        VideoLayer,
        {
          src: overlayUrl,
          muted: true,
      ...
      /* @__PURE__ */ (0, import_jsx_runtime3.jsx)(SlideText, { text: slide.text || "", bottomOffset: textBottomOffset, fontSize: textFontSize })
    ] });
  };
  var MutabaatComposition = ({
    slides,
    overlayUrl,
    finalOverlayUrl,
    bgMusicUrl,
    ...
    let from = 0;
    return /* @__PURE__ */ (0, import_jsx_runtime3.jsxs)(AbsoluteFill, { style: { backgroundColor: "#000" }, children: [
      /* @__PURE__ */ (0, import_jsx_runtime3.jsx)(Audio, { src: bgMusicUrl || DEFAULT_MUSIC, volume: bgMusicVolume, loop: true }),
      normalizedSlides.map((slide, index) => {
        ...
        const slideOverlay = index === normalizedSlides.length - 1 ? finalOverlayUrl || DEFAULT_FINAL_OVERLAY : overlayUrl || DEFAULT_OVERLAY;
        return /* @__PURE__ */ (0, import_jsx_runtime3.jsx)(Sequence, { from: sequenceFrom, durationInFrames, layout: "none", children: /* @__PURE__ */ (0, import_jsx_runtime3.jsx)(
          MutabaatSlideScene,
          {
            slide,
  ...
  var currentPayload = defaultPayload;
  ...
  var PreviewApp = ({ payload }) => {
    ...
    import_react3.default.useEffect(() => {
      ...
      return () => {
        if (currentPlayerRef === playerRef.current)
  ...
  function render() {
    if (!root)
      return;
    root.render(/* @__PURE__ */ (0, import_jsx_runtime4.jsx)(PreviewApp, { payload: currentPayload }));
  }
