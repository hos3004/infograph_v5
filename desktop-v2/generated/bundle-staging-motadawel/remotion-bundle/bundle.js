...
;// CONCATENATED MODULE: ./src/remotion/motadawel/types.ts
const MOTADAWEL_TEXT_PRESETS = {
...
;// CONCATENATED MODULE: ./src/remotion/motadawel/MotadawelComposition.tsx
...
if (typeof document !== "undefined") {
  const fontUrl = (0,cjs.staticFile)("assets/fonts/alfont_com_AlFont_com_AvenirArabic-Heavy.otf");
  const style = document.createElement("style");
  style.textContent = `
    @font-face {
...
const TransitionFadeIn = ({ overlap, children }) => {
  const frame = (0,cjs.useCurrentFrame)();
  const opacity = overlap > 0 ? (0,cjs.interpolate)(frame, [0, overlap], [0, 1], { extrapolateRight: "clamp" }) : 1;
  return /* @__PURE__ */ react.createElement(cjs.AbsoluteFill, { style: { opacity } }, children);
};
const TYPEWRITER_START = 10;
const FRAMES_PER_CHAR = 1;
const CURSOR_BLINK_RATE = 8;
const isRTL = (s) => /[\u0591-\u07FF\uFB1D-\uFDFD\uFE70-\uFEFC]/.test(s);
const MotadawelSubtitle = ({ text, bottomOffset, fontSize, preset, animationType = "motion-blur" }) => {
  const frame = (0,cjs.useCurrentFrame)();
  ...
  const xOffset = (0,cjs.interpolate)(frame, [0, 210], [0, 222], { extrapolateLeft: "clamp", extrapolateRight: "clamp" });
  ...
  const strokeProgress = (0,cjs.interpolate)(frame, [10, 180], [0, 100], { extrapolateRight: "clamp", extrapolateLeft: "clamp" });
  const strokeHeight = Math.max(3, Math.round(fontSize * 0.07));
  const glassProgress = (0,cjs.interpolate)(frame, [10, 85], [-120, 200], { extrapolateRight: "clamp", extrapolateLeft: "clamp" });
  const isVisibleDelay = frame > 10;
  const entryOpacity = (0,cjs.interpolate)(frame, [10, 10 + ENTRY_DUR], [0, 1], { extrapolateLeft: "clamp", extrapolateRight: "clamp" });
...
const MotadawelComposition = ({
  ...
  return /* @__PURE__ */ react.createElement(cjs.AbsoluteFill, { style: { backgroundColor: "#000", direction: "ltr" } }, hasIntro && /* @__PURE__ */ react.createElement(cjs.Sequence, { from: 0, durationInFrames: introFrames, layout: "none" }, /* @__PURE__ */ react.createElement(cjs.AbsoluteFill, null, /* @__PURE__ */ react.createElement(
    cjs.Video,
    {
      src: introVideoUrl,
      style: { width: "100%", height: "100%", objectFit: "cover" }
    }
  ))), mainFrames > 0 && /* @__PURE__ */ react.createElement(cjs.Sequence, { from: mainStart, durationInFrames: mainFrames, layout: "none" }, /* @__PURE__ */ react.createElement(TransitionFadeIn, { overlap: introOverlap }, bgMusicUrl && /* @__PURE__ */ react.createElement(cjs.Audio, { src: bgMusicUrl, volume: bgMusicVolume ?? 0.25 }), /* @__PURE__ */ react.createElement(cjs.AbsoluteFill, { style: { backgroundColor: "#000" } }), /* @__PURE__ */ react.createElement(
    cjs.AbsoluteFill,
    {
      style: {
        display: "flex",
    ...
    mainVideoUrl ? /* @__PURE__ */ react.createElement(
      cjs.Video,
      {
        src: mainVideoUrl,
        style: {
  ...
  ), frameUrl && /* @__PURE__ */ react.createElement(cjs.AbsoluteFill, { style: { pointerEvents: "none" } }, isImageFrame ? /* @__PURE__ */ react.createElement(
    cjs.Img,
    {
      src: frameUrl,
  ...
  ))), hasOutro && outroFrames > 0 && /* @__PURE__ */ react.createElement(cjs.Sequence, { from: outroStart, durationInFrames: outroFrames, layout: "none" }, /* @__PURE__ */ react.createElement(TransitionFadeIn, { overlap: outroOverlap }, /* @__PURE__ */ react.createElement(cjs.AbsoluteFill, null, /* @__PURE__ */ react.createElement(
    cjs.Video,
    {
      src: outroVideoUrl,
      style: { width: "100%", height: "100%", objectFit: "cover" }
    }
  )))), /* @__PURE__ */ react.createElement(VisualEffects, { effects, cinematicBarSize }));
};

;// CONCATENATED MODULE: ./src/remotion/motadawel/RootMotadawel.tsx
...
const MotadawelRoot = () => /* @__PURE__ */ react.createElement(react.Fragment, null, /* @__PURE__ */ react.createElement(
  cjs.Composition,
  {
    id: "MotadawelVideo",
...
;// CONCATENATED MODULE: ./src/remotion/motadawel/index.ts


(0,cjs.registerRoot)(MotadawelRoot);
