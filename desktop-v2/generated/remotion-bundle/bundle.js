...
;// CONCATENATED MODULE: ./src/remotion/types.ts
const TEXT_PRESETS = {
...
;// CONCATENATED MODULE: ./src/remotion/Transitions.tsx
...
const TRANSITION_DURATION_FRAMES = 30;
const getEffectByIndex = (index) => {
  const options = ["fade", "light-leak", "blur-wipe"];
  return options[(index - 1) % options.length];
};
const TransitionOverlay = ({ type, frameInTransition, duration }) => {
  if (frameInTransition < 0 || frameInTransition > duration)
    return null;
  const progress = frameInTransition / duration;
  if (type === "light-leak") {
    const opacity = (0,cjs.interpolate)(progress, [0, 0.5, 1], [0, 0.8, 0], { extrapolateRight: "clamp" });
...
const EnterTransition = ({ type, children }) => {
  ...
  return /* @__PURE__ */ React.createElement("div", { style: { ...style, width: "100%", height: "100%", position: "absolute" } }, children);
};

;// CONCATENATED MODULE: ./src/remotion/Slide.tsx
...
if (typeof document !== "undefined") {
  const fontUrl = (0,cjs.staticFile)("assets/fonts/rb.ttf");
  const style = document.createElement("style");
  style.textContent = `
    @font-face {
...
function getSlideContainerStyle(type, frame, durationFrames) {
  ...
  if (type === "fade" || type === "light-leak") {
    return {
      opacity: (0,cjs.interpolate)(frame, [0, d], [0, 1], { extrapolateRight: "clamp" })
    };
  }
  if (type === "blur-wipe") {
    const blur = (0,cjs.interpolate)(frame, [0, d * 0.6, d], [22, 8, 0], { extrapolateRight: "clamp" });
    const opacity = (0,cjs.interpolate)(frame, [0, d * 0.4, d], [0, 0.6, 1], { extrapolateRight: "clamp" });
    return { filter: `blur(${blur}px)`, opacity };
  }
  return {};
}
const Slide = ({ slide, index, isFirst, textBottomOffset, textFontSize, textPreset, textAnimationType }) => {
  ...
  const scale = (0,cjs.interpolate)(frame, [0, durationInFrames], [startScale, endScale], {
    extrapolateRight: "clamp"
  });
  ...
  return /* @__PURE__ */ react.createElement(
    ...
    /\.(mp4|mov|webm|mkv)$/i.test(slide.imageUrl) ? /* @__PURE__ */ react.createElement(
      cjs.Video,
      {
        src: slide.imageUrl,
    ...
    slide.text ? /* @__PURE__ */ react.createElement(
      Subtitle,
      {
        text: slide.text,
...
const Subtitle = ({ text, bottomOffset, fontSize, preset, textAnimationType, isFirst }) => {
  const frame = (0,cjs.useCurrentFrame)();
  ...
  const xOffset = (0,cjs.interpolate)(relativeFrame, [0, 210], [0, 222], { extrapolateLeft: "clamp", extrapolateRight: "clamp" });
  ...
  const strokeProgress = (0,cjs.interpolate)(relativeFrame, [0, 180], [0, 100], { extrapolateRight: "clamp" });
  const strokeHeight = Math.max(3, Math.round(fontSize * 0.07));
  const slideDurationFrames = 150;
  const glassProgress = (0,cjs.interpolate)(relativeFrame, [0, Math.floor(slideDurationFrames / 2)], [-120, 200], { extrapolateRight: "clamp" });
  const isVisibleDelay = relativeFrame > 0;
  const entryOpacity = (0,cjs.interpolate)(relativeFrame, [0, ENTRY_DUR], [0, 1], { extrapolateLeft: "clamp", extrapolateRight: "clamp" });
  ...
  return /* @__PURE__ */ react.createElement(react.Fragment, null, /* @__PURE__ */ react.createElement(
    ...
    visibleLines.map((lineText, i) => {
      ...
      const lineEntryOpacity = (0,cjs.interpolate)(lineRelativeFrame, [0, ENTRY_DUR], [0, 1], { extrapolateLeft: "clamp", extrapolateRight: "clamp" });
      const lineEntryYOffset = (0,cjs.interpolate)(lineRelativeFrame, [0, ENTRY_DUR], [40, 0], { extrapolateLeft: "clamp", extrapolateRight: "clamp" });
      const lineEntryBlur = (0,cjs.interpolate)(lineRelativeFrame, [0, ENTRY_DUR], [15, 0], { extrapolateLeft: "clamp", extrapolateRight: "clamp" });
      ...
      return /* @__PURE__ */ react.createElement(
        ...
        /* @__PURE__ */ react.createElement("div", { style: isTypewriter ? { direction: isRTL_line ? "rtl" : "ltr" } : {} }, lineText.trim(), isCurrentTypingLine && cursorOn && /* @__PURE__ */ react.createElement("span", { style: { display: "inline-block", width: "3px", height: "0.85em", backgroundColor: color, marginRight: "4px", verticalAlign: "middle", opacity: 0.8 } }))
      );
    })
  ));
};

;// CONCATENATED MODULE: ./src/remotion/VisualEffects.tsx


const VisualEffects = ({ effects, cinematicBarSize = 6 }) => {
  if (!effects || effects.length === 0)
    return null;
  return /* @__PURE__ */ react.createElement(cjs.AbsoluteFill, { style: { pointerEvents: "none", zIndex: 10 } }, effects.includes("dust") && /* @__PURE__ */ react.createElement(DustParticles, null), effects.includes("light-leak") && /* @__PURE__ */ react.createElement(LightLeaks, null), effects.includes("bokeh") && /* @__PURE__ */ react.createElement(BokehEffect, null), effects.includes("scanlines") && /* @__PURE__ */ react.createElement(Scanlines, null), effects.includes("grain") && /* @__PURE__ */ react.createElement(FilmGrain, null), effects.includes("vignette") && /* @__PURE__ */ react.createElement(Vignette, null), effects.includes("cinematic-bars") && /* @__PURE__ */ react.createElement(CinematicBars, { barSize: cinematicBarSize }));
};
const DustParticles = () => {
  const frame = (0,cjs.useCurrentFrame)();
  const COUNT = 50;
  ...
  return /* @__PURE__ */ react.createElement(cjs.AbsoluteFill, null, /* @__PURE__ */ react.createElement("svg", { width: "1920", height: "1080", style: { position: "absolute" } }, particles.map((p, i) => /* @__PURE__ */ react.createElement(
    "circle",
    {
      key: i,
      cx: p.x,
...
const LightLeaks = () => {
  const frame = (0,cjs.useCurrentFrame)();
  const x1 = (0,cjs.interpolate)(Math.sin(frame * 0.012), [-1, 1], [-200, 100]);
  const y1 = (0,cjs.interpolate)(Math.cos(frame * 9e-3), [-1, 1], [-150, 50]);
  const op1 = (0,cjs.interpolate)(Math.sin(frame * 0.018), [-1, 1], [0.08, 0.22]);
  const x2 = (0,cjs.interpolate)(Math.sin(frame * 0.014 + 2), [-1, 1], [1600, 2e3]);
  const y2 = (0,cjs.interpolate)(Math.cos(frame * 0.011 + 1), [-1, 1], [700, 1e3]);
  const op2 = (0,cjs.interpolate)(Math.sin(frame * 0.016 + 1), [-1, 1], [0.05, 0.18]);
  return /* @__PURE__ */ react.createElement(cjs.AbsoluteFill, null, /* @__PURE__ */ react.createElement("svg", { width: "1920", height: "1080", style: { position: "absolute" } }, /* @__PURE__ */ react.createElement("defs", null, /* @__PURE__ */ react.createElement("radialGradient", { id: "lg1", cx: "50%", cy: "50%", r: "50%" }, /* @__PURE__ */ react.createElement("stop", { offset: "0%", stopColor: "#ff9900", stopOpacity: "1" }), /* @__PURE__ */ react.createElement("stop", { offset: "60%", stopColor: "#ff5500", stopOpacity: "0.4" }), /* @__PURE__ */ react.createElement("stop", { offset: "100%", stopColor: "#ff3300", stopOpacity: "0" })), /* @__PURE__ */ react.createElement("radialGradient", { id: "lg2", cx: "50%", cy: "50%", r: "50%" }, /* @__PURE__ */ react.createElement("stop", { offset: "0%", stopColor: "#ffcc44", stopOpacity: "1" }), /* @__PURE__ */ react.createElement("stop", { offset: "70%", stopColor: "#ff8800", stopOpacity: "0.3" }), /* @__PURE__ */ react.createElement("stop", { offset: "100%", stopColor: "#ff6600", stopOpacity: "0" }))), /* @__PURE__ */ react.createElement(
    "ellipse",
    {
      cx: x1,
      cy: y1,
...
const BokehEffect = () => {
  ...
  return /* @__PURE__ */ react.createElement(cjs.AbsoluteFill, null, /* @__PURE__ */ react.createElement("svg", { width: "1920", height: "1080", style: { position: "absolute" } }, /* @__PURE__ */ react.createElement("defs", null, /* @__PURE__ */ react.createElement("filter", { id: "bokeh-blur" }, /* @__PURE__ */ react.createElement("feGaussianBlur", { stdDeviation: "28" }))), circles.map((c, i) => {
...
const FilmGrain = () => {
  ...
  return /* @__PURE__ */ react.createElement(cjs.AbsoluteFill, { style: { overflow: "hidden", mixBlendMode: "overlay", opacity: 0.15 } }, /* @__PURE__ */ react.createElement(
    "svg",
    {
      width: "200%",
      height: "200%",
    ...
    /* @__PURE__ */ react.createElement("filter", { id: "film-grain" }, /* @__PURE__ */ react.createElement("feTurbulence", { type: "fractalNoise", baseFrequency: "0.65", numOctaves: "1", seed: "10" }), /* @__PURE__ */ react.createElement("feColorMatrix", { type: "saturate", values: "0" })),
    /* @__PURE__ */ react.createElement("rect", { width: "100%", height: "100%", filter: "url(#film-grain)" })
  ));
};
const Vignette = () => {
  return /* @__PURE__ */ react.createElement(cjs.AbsoluteFill, { style: {
...
const CinematicBars = ({ barSize }) => {
  const heightStr = `${barSize}%`;
  return /* @__PURE__ */ react.createElement(cjs.AbsoluteFill, { style: { display: "flex", flexDirection: "column", justifyContent: "space-between" } }, /* @__PURE__ */ react.createElement("div", { style: { width: "100%", height: heightStr, backgroundColor: "#000" } }), /* @__PURE__ */ react.createElement("div", { style: { width: "100%", height: heightStr, backgroundColor: "#000" } }));
};

;// CONCATENATED MODULE: ./src/remotion/MainComposition.tsx
...
const MainComposition = ({
  ...
  return /* @__PURE__ */ react.createElement(cjs.AbsoluteFill, { style: { backgroundColor: "#000", direction: "ltr" } }, validSlides.map((slide, i) => {
  ...
  }), endPage && EP_FRAMES > 0 && /* @__PURE__ */ react.createElement(
    cjs.Sequence,
    {
      from: epStartFrame,
    ...
    /* @__PURE__ */ react.createElement(EndPageFade, { src: endPage, fadeFrames: EP_FADE_FRAMES })
  ), overlay && (() => {
    ...
    return /* @__PURE__ */ react.createElement(cjs.Sequence, { from: 0, durationInFrames: totalVideoFrames || durationInFrames }, isImageOverlay ? /* @__PURE__ */ react.createElement(cjs.Img, { src: overlay, style: overlayStyle }) : /* @__PURE__ */ react.createElement(cjs.Video, { src: overlay, style: overlayStyle, loop: true, muted: true }));
  })(), music && /* @__PURE__ */ react.createElement(
    cjs.Audio,
    {
      src: music,
      loop: true,
      volume: (frame) => {
        ...
        if (fadeStart >= durationInFrames)
          return baseVol;
        return (0,cjs.interpolate)(frame, [fadeStart, durationInFrames], [baseVol, 0], {
          extrapolateLeft: "clamp",
          extrapolateRight: "clamp"
        });
      }
    }
  ), voiceover && /* @__PURE__ */ react.createElement(
    cjs.Audio,
    {
      src: voiceover,
      volume: (frame) => {
  ...
  ), /* @__PURE__ */ react.createElement(VisualEffects, { effects: effects ?? [], cinematicBarSize: cinematicBarSize ?? 6 }));
};
const EndPageFade = ({ src, fadeFrames }) => {
  const frame = (0,cjs.useCurrentFrame)();
  const opacity = (0,cjs.interpolate)(frame, [0, fadeFrames], [0, 1], {
    extrapolateLeft: "clamp",
    extrapolateRight: "clamp"
  });
  return /* @__PURE__ */ react.createElement(cjs.AbsoluteFill, { style: { backgroundColor: "#000", opacity } }, /* @__PURE__ */ react.createElement(
    cjs.Video,
    {
      src,
  ...
  return /* @__PURE__ */ react.createElement(react.Fragment, null, /* @__PURE__ */ react.createElement(
    cjs.Composition,
    {
      ...
      calculateMetadata: ({ props }) => {
        ...
        const EP_FADE_FRAMES = 50;
        let totalDuration = framesPerSlide;
        if (validLength > 0) {
          const slideEndFrame = validLength * (framesPerSlide - overlapFrames) + overlapFrames;
          totalDuration = endPageFrames > 0 ? slideEndFrame + endPageFrames - EP_FADE_FRAMES : slideEndFrame;
        }
